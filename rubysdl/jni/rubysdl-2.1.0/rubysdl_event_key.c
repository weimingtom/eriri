...
static void define_const(void)
{
  ...
  /* Numeric keypad */
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "KP0", INT2NUM(SDLK_KP_0));
  rb_define_const(mKey, "KP1", INT2NUM(SDLK_KP_1));
  rb_define_const(mKey, "KP2", INT2NUM(SDLK_KP_2));
  rb_define_const(mKey, "KP3", INT2NUM(SDLK_KP_3));
  rb_define_const(mKey, "KP4", INT2NUM(SDLK_KP_4));
  rb_define_const(mKey, "KP5", INT2NUM(SDLK_KP_5));
  rb_define_const(mKey, "KP6", INT2NUM(SDLK_KP_6));
  rb_define_const(mKey, "KP7", INT2NUM(SDLK_KP_7));
  rb_define_const(mKey, "KP8", INT2NUM(SDLK_KP_8));
  rb_define_const(mKey, "KP9", INT2NUM(SDLK_KP_9));
#else
...
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "NUMLOCK", INT2NUM(SDLK_NUMLOCKCLEAR));
#else
  rb_define_const(mKey, "NUMLOCK", INT2NUM(SDLK_NUMLOCK));
#endif
  rb_define_const(mKey, "CAPSLOCK", INT2NUM(SDLK_CAPSLOCK));
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "SCROLLOCK", INT2NUM(SDLK_SCROLLLOCK));
#else
...
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "RMETA", INT2NUM(SDLK_RGUI));
  rb_define_const(mKey, "LMETA", INT2NUM(SDLK_LGUI));
#else
...
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "PRINT", INT2NUM(SDLK_PRINTSCREEN));
#else
  rb_define_const(mKey, "PRINT", INT2NUM(SDLK_PRINT));
#endif
  rb_define_const(mKey, "SYSREQ", INT2NUM(SDLK_SYSREQ));
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "BREAK", INT2NUM(SDLK_PAUSE));
#else
...
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "MOD_LMETA", UINT2NUM(KMOD_LGUI));
  rb_define_const(mKey, "MOD_RMETA", UINT2NUM(KMOD_RGUI));
#else
...
#if SDL_MAJOR_VERSION == 2
  rb_define_const(mKey, "MOD_META", UINT2NUM(KMOD_GUI));
#else
...
static VALUE Key_s_press_p(VALUE mod, VALUE keysym)
{
  ...
  rb_secure(4);
#if (SDL_MAJOR_VERSION == 1 && SDL_MINOR_VERSION == 3) || SDL_MAJOR_VERSION == 2
  if(sym < 0 || SDLK_SCANCODE_MASK <= sym )
