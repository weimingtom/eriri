...
void GENERATED_TMP_mrb_mruby_print_android_gem_init(mrb_state*);
void GENERATED_TMP_mrb_mruby_print_android_gem_final(mrb_state*);
...
#if defined(ANDROID)
  GENERATED_TMP_mrb_mruby_print_android_gem_final(mrb);
#endif
}
...
#if defined(ANDROID)
  GENERATED_TMP_mrb_mruby_print_android_gem_init(mrb);
#endif
